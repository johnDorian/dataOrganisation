...
\begin{center}
\begin{figure}
\includegraphics[scale=0.5]{TP_cloud.pdf}
\caption{Semi Variogram cloud of total Phosporous with box-cox transformation (lambda = -0.4). Red line indicates the likfit model.}
\label{fig:tp_sv}
\end{figure}
\end{center}
